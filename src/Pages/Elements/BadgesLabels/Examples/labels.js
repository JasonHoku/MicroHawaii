              ...
              <Col lg="6">
                <Card className="main-card mb-3">
                  <CardBody>
                    ...
                    <a href="https://colorlib.com/" onClick={(e) => e.preventDefault()} className="mb-2 mr-2 badge badge-primary">
                      Primary
                    </a>
                    <a href="https://colorlib.com/" onClick={(e) => e.preventDefault()} className="mb-2 mr-2 badge badge-secondary">
                      Secondary
                    </a>
                    <a href="https://colorlib.com/" onClick={(e) => e.preventDefault()}className="mb-2 mr-2 badge badge-success">
                      Success
                    </a>
                    <a href="https://colorlib.com/" onClick={(e) => e.preventDefault()} className="mb-2 mr-2 badge badge-info">
                      Info
                    </a>
                    <a href="https://colorlib.com/" onClick={(e) => e.preventDefault()} className="mb-2 mr-2 badge badge-warning">
                      Warning
                    </a>
                    <a href="https://colorlib.com/" onClick={(e) => e.preventDefault()} className="mb-2 mr-2 badge badge-danger">
                      Danger
                    </a>
                    <a href="https://colorlib.com/" onClick={(e) => e.preventDefault()} className="mb-2 mr-2 badge badge-focus">
                      Focus
                    </a>
                    <a href="https://colorlib.com/" onClick={(e) => e.preventDefault()} className="mb-2 mr-2 badge badge-alternate">
                      Alt
                    </a>
                    <a href="https://colorlib.com/" onClick={(e) => e.preventDefault()} className="mb-2 mr-2 badge badge-light">
                      Light
                    </a>
                    <a href="https://colorlib.com/" onClick={(e) => e.preventDefault()} className="mb-2 mr-2 badge badge-dark">
                      Dark
                    </a>
                  </CardBody>
                </Card>

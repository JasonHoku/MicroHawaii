            ...
            <Col md="6">
              ...
              <Card className="main-card mb-3">
                <CardBody>
                  ...
                  <div className="text-center">
                    <div className="switch has-switch has-switch-sm mr-2 mb-2 mr-2" data-on-label="ON"
                      data-off-label="OFF" onClick={this.handleClick}>
                      <div className={cx("switch-animate", {
                          "switch-on": this.state.isToggleOn,
                          "switch-off": !this.state.isToggleOn,
                ...
                <CardBody>
                  ...
                  <Row className="text-center">
                    <Col md="6">
                      ...
                      <Switch checked={this.state.checked} onChange={this.handleChange} className="mr-2 mb-2"/>
                      <Switch checked={this.state.checked} onChange={this.handleChange} disabled className="mr-2 mb-2"/>
                    </Col>
                    <Col md="6">
                      ...
                      <Switch checked={this.state.checked} onChange={this.handleChange} onColor="#86d3ff"
                        ...
                        height={20} width={48} className="mr-2 mb-2" id="material-switch"/>
                      <Switch onChange={this.handleChange} checked={this.state.checked}
                        className="mr-2 mb-2" id="normal-switch"/>
                    </Col>
                  </Row>

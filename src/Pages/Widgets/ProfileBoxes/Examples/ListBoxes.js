                          ...
                          <div className="widget-content p-0">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-right widget-content-actions">
                                <Button size="sm" className="mr-1 btn-icon btn-icon-only" color="primary">
                                  <i className="pe-7s-tools btn-icon-wrapper"> {" "} </i>
                                </Button>
                                <Button size="sm" className="mr-1 btn-icon btn-icon-only" color="secondary">
                  ...
                  <div className="dropdown-menu-header">
                    <div className="dropdown-menu-header-inner bg-danger">
                      ...
                      <div className="menu-header-content btn-pane-right">
                        ...
                        <div className="menu-header-btn-pane">
                          <Button size="sm" className="btn-icon mr-2 btn-icon-only" color="warning">
                            <i className="pe-7s-config btn-icon-wrapper"> </i>
                          </Button>

                  ...
                  <div className="widget-chart-wrapper">
                    <ResponsiveContainer width="100%" aspect={3.0 / 1.0}>
                      <LineChart data={data} margin={{ top: 0, right: 5, left: 5, bottom: 0 }}>
                        <Line type="monotone" dataKey="pv" stroke="#eeeeee" strokeWidth={3}/>
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </div>
              ...
              <Col md="4">
                <div className="card mb-3 widget-chart bg-tempting-azure card-border">
                  ...
                  <div className="widget-chart-wrapper chart-wrapper-relative">
                    <ResponsiveContainer width="100%" aspect={3.0 / 1.0}>
                      <AreaChart data={data} margin={{ top: 0, right: 0, left: 0, bottom: 0 }}>
                        <Area type="monotoneX" dataKey="uv" stroke="#eeeeee" fill="rgba(255,255,255,.2)"/>
                      </AreaChart>
                    </ResponsiveContainer>
                  </div>
                </div>
                  ...
                  <div className="widget-chart-wrapper chart-wrapper-relative">
                    <ResponsiveContainer width="100%" aspect={3.0 / 1.0}>
                      <LineChart data={data2} margin={{ top: 0, right: 5, left: 5, bottom: 0 }}>
                        <Line type="monotone" dataKey="pv" stroke="#eeeeee" strokeWidth={2}/>
                  ...
                  <div className="widget-chart-wrapper chart-wrapper-relative">
                    <ResponsiveContainer width="100%" aspect={3.0 / 1.0}>
                      <ComposedChart data={data2}>
                        ...
                        <Line type="monotone" dataKey="uv" stroke="#eeeeee" />
                      </ComposedChart>
                    </ResponsiveContainer>
                  </div>
                </div>

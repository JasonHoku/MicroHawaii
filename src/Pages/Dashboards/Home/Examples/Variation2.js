      ...
      <Fragment>
        ...
        ><center>
            ...
            <Col mx-auto
              ...
              <Card className="mb-3 main-card" style={{ 
                ...
                <CardBody>
                  {" "}
                  <div>
                    <small> 10/17/20 </small> <br></br> <br></br>
            ...
            <Col>
              <Card className="main-card mb-3" style={{
                ...
                <CardBody>
                  ...
                  <br></br>
                  <br></br>
                  Find out what mciroHawaii is working on, get involved and learn more,
                  by visiting the new
          ...
          <Card className="main-card mb-3" style={{
            ...
            <CardBody>
              The mciroHawaii 3D Web-Game development is kicking off! Pre-Alpha 0.2 is
              now available

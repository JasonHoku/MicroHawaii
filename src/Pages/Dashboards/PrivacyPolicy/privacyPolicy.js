              ...
              <Card>
                <CardBody>
                  ...
                  <ul>
                    ...
                    <li>
                      <p>
                        <strong>Country</strong> refers to: Hawaii, United
                        States
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p>
                        <strong>Website</strong> refers to MicroHawaii,
                        accessible from{" "}
                        <a
                          href="https://MicroHawaii.com/"
                          rel="external nofollow noopener"
                          target="_blank"
                        >
                          https://MicroHawaii.com/
                        </a>
                      </p>
                    </li>
                    <li>
                  ...
                  <ul>
                    <li>
                      <p>By email: admin@MicroHawaii.com</p>
                    </li>
                    <li>
                      <p>
